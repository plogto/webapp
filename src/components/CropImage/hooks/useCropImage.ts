...
import { CROP_IMAGES_TYPES } from "../CropImage.constants";
import type { UseCropImageProps, PixelCrop } from "../CropImage.types";
import { readFile } from "../CropImage.utils";
...
export function useCropImage(props: UseCropImageProps) {
  ...
  const onCropComplete = useCallback((_: unknown, pixelCrop: PixelCrop) => {
